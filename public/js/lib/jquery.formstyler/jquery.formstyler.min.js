...
a.css({position:"absolute",left:-9999}).each(function(){if(1>a.next("span.jq-radio").length){var b=d("<span class='radio-wrap'><span"+l+' class="jq-radio'+q+'" style="display: inline-block"><span></span></span></span>');a.after(b);a.is(":checked")&&b.addClass("checked");a.is(":disabled")&&b.addClass("disabled");b.click(function(){if(!b.is(".disabled"))return d('input[name="'+a.attr("name")+'"]').prop("checked",!1).next().removeClass("checked"),a.prop("checked",!0).next().addClass("checked"),a.change(),!1});a.parent("label").add('label[for="'+
