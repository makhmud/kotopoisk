<main ng-if="!settings.showChooseMapPosition">
    <form id="add-cat" name="AddCatForm" enctype='multipart/form-data'>
        <div id="photos" flow-init="ngFlowParams" flow-files-submitted="$flow.upload()" flow-file-success="newCat.photos.push($message)">
            ...
            <div class="file-button-container-big"  ng-if="newCat.photos.length < 4">
        ...
        <button type="button" class="text-center" id="add-more-photo">+ добавить еще фото</button>
        ...
        <input type="text" placeholder="Адрес" ng-keyup="doSearch()" ng-model="newCat.address" required="required"/>
        <span>или</span>
