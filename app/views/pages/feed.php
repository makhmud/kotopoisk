<div class="main-switch" ng-if="!page.search">
    <a href="javascript:void()" class="{{(settings.catsOrder==null)?'active':''}}" ng-click="reOrder()" ng-bind="'page.feed.new' | translate"></a>
    <a href="javascript:void()" class="{{(settings.catsOrder!=null)?'active':''}}" ng-click="reOrder('count_likes')" ng-bind="'page.feed.popular' | translate">Популярное</a>
</div>
